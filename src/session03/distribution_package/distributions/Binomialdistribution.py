...
class Binomial(Distribution):
    ...
    def __init__(self, prob=0.5, size=20):
        ...
        Distribution.__init__(
            self, mu=self.calculate_mean(), sigma=self.calculate_stdev()
        )
    ...
    def calculate_stdev(self):
        ...
        self.stdev = math.sqrt(self._n * self._p * (1 - self._p))
        return self.stdev
    ...
    def plot_bar(self):
        ...
        x, height = Counter(self.data).items()
        plt.bar(x, height, label="title")
        plt.xlabel("outcome")
    ...
    def __add__(self, other):
        ...
        return Binomial(self._p, self._n + other._n)
    ...
    def __repr__(self):
        ...
        return f"mean {self.mean}, standard deviation {self.stdev}, p {self._p}, n {self._n}"
